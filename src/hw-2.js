...
console.log(task3({ country: 'Belarus', city: 'Minsk' }, 'city'));
console.log(task3({ country: 'Belarus' }, 'city'));
...
console.log(task4({ country: 'Belarus', city: 'Minsk' }));
...
function task5(obj1, obj2) {
  ...
  let numObj1 = 0;
  let numObj2 = 0;
  for (const key1 in obj1) {numObj1 += key1};

  for (const key2 in obj2) {numObj2 += key2};
...
console.log(task6({country: 'Belarus', city: 'Minsk'}));
